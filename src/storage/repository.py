...
class SentinelRepository:
    ...
    def get_predictions_for_evaluation(
        ...
        """
        Return predictions ordered oldest -> newest with just the
        columns needed to score forecast accuracy.

        For every prediction made at time T we later look for a
        reading close to T + horizon for the same module to see what
        the temperature actually turned out to be.
        """
