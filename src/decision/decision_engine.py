...
class TemperatureDecisionEngine:
    ...
    def __init__(
        ...
        # Delta values are retained for trend information and
        # optional escalation logic. Absolute forecast thresholds
        # remain the primary alert criteria.
        self.delta_warning = delta_warning
        self.delta_critical = delta_critical
    ...
    def evaluate(
        ...
        # =====================================================
        # RISK FROM 5-MINUTE FORECAST
        # =====================================================
        #
        # IMPORTANT:
        #
        # The forecast itself is the source of truth for the
        # alert threshold.
        #
        # forecast < warning
        #       -> NORMAL
        #
        # warning <= forecast < critical
        #       -> WARNING
        #
        # forecast >= critical
        #       -> CRITICAL
        #
        # Therefore, a forecast above the warning threshold
        # remains a WARNING even when the temperature is falling.
        #
        # This prevents a dangerous forecast from being hidden
        # merely because its short-term delta is negative.
        # =====================================================
        ...
        # =====================================================
        #
        # Trend can strengthen NORMAL -> WARNING when the
        # forecast is close to the warning threshold and rising.
        #
        # Trend can strengthen WARNING -> CRITICAL when the
        # forecast is already at/above warning and the increase
        # is significant.
        #
        # Trend NEVER downgrades WARNING/CRITICAL below their
        # absolute forecast threshold.
        # =====================================================

        if temperature_delta is not None:

            # Normal forecast close to warning + strong rise.
            if (
                risk == "NORMAL"
                and temperature_delta >= self.delta_warning
                and predicted_temperature >= warning * 0.98
            ...
            # Warning forecast + strong rise -> Critical.
            elif (
                risk == "WARNING"
                and temperature_delta >= self.delta_critical
            ):
